...
export default function ChangeEmailEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm your Axyl email change</Preview>
      <Body style={body}>
        <Container style={container}>
          <Section>
            ...
            <Text style={text}>
              We received a request to change your Axyl account email to{" "}
              <strong>{newEmail}</strong>.
            </Text>
            <Text style={text}>
              If this was you, confirm the change using the button below:
            </Text>
...
ChangeEmailEmail.PreviewProps = {
  ...
  confirmUrl: "https://example.com/confirm-email-change",
